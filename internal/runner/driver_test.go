...
func TestGitHubDriver_scopeParsing_org(t *testing.T) {
	d, err := newGitHubDriverWithClient(nil, "org:my-org", "", nil, nil)
	if err != nil {
...
func TestGitHubDriver_scopeParsing_repo(t *testing.T) {
	d, err := newGitHubDriverWithClient(nil, "repo:owner/myrepo", "", nil, nil)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestGitHubDriver_scopeParsing_invalid(t *testing.T) {
	_, err := newGitHubDriverWithClient(nil, "invalid-scope", "", nil, nil)
	if err == nil {
...
func TestGitHubDriver_scopeParsing_repoMissingSlash(t *testing.T) {
	_, err := newGitHubDriverWithClient(nil, "repo:noslash", "", nil, nil)
	if err == nil {
